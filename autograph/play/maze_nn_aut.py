...
if __name__ == '__main__':
    ...
    p.add_argument("--render", dest="render_playstep", action="store_true")

    args = vars(p.parse_args())

    RENDER = args.get("render_playstep", False)
...
def run_aut_episode(net: torch.nn.Module, env: AutShapingWrapper, max_length: int, max_len_reward: Optional[int],
                    ...
                    state_observer: Callable[[Any], None] = None) -> Tuple[
